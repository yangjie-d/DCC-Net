...
class Visualizer:
    ...
    def draw_instance_predictions(self, predictions, jittering: bool = True):
        ...
        # cv2.imshow('ss', self.output.get_image()[:, :, ::-1])
        # cv2.waitKey(0)
        # exit()
        return self.output
    ...
    def draw_dataset_dict(self, dic):
        ...
        if sem_seg is not None:
            self.draw_sem_seg(sem_seg, area_threshold=0, alpha=0.1)
        ...
        if pan_seg is not None:
            ...
            self.draw_panoptic_seg(pan_seg, segments_info, area_threshold=0, alpha=0.1)
        return self.output
